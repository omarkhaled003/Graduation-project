...
export default defineConfig({
  ...
  server: {
    proxy: {
      '/api': {
        target: 'https://ecofiy.yellowground-44551b7b.italynorth.azurecontainerapps.io',
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path,
        configure: (proxy, _options) => {
          ...
          proxy.on('proxyReq', (proxyReq, req, _res) => {
            proxyReq.setHeader('Origin', 'https://ecofiy.yellowground-44551b7b.italynorth.azurecontainerapps.io');
